...
export default function CollectPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto bg-green-50 min-h-screen">
  <h1 className="text-3xl font-semibold mb-6 text-green-800">
  ...
  <div className="mb-4 flex items-center">
    <Input
      ...
      className="mr-2 border border-green-300 rounded-lg focus:ring-green-500"
    />
    <Button variant="outline" size="icon" className="border-green-300 text-green-600 hover:bg-green-100">
    ...
    <>
      <div className="space-y-4">
        {paginatedTasks.map((task) => (
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 text-sm text-green-600 mb-3">
              <div className="flex items-center relative">
                <Trash2 className="w-4 h-4 mr-2 text-green-500" />
                <span
                ...
                {hoveredWasteType === task.wasteType && (
                  <div className="absolute left-0 top-full mt-1 p-2 bg-green-800 text-white text-xs rounded shadow-lg z-10">
                    {task.wasteType}
                  </div>
                )}
              </div>
      ...
      <div className="mt-4 flex justify-center">
        <Button
          ...
          className="mr-2 border-green-300 text-green-600 hover:bg-green-100"
        >
          Previous
        </Button>
        <span className="mx-2 self-center text-green-800">
        ...
        <Button
          ...
          className="ml-2 border-green-300 text-green-600 hover:bg-green-100"
        >
          Next
        </Button>
      </div>
  ...
  {selectedTask && (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-green-300">
        <h3 className="text-xl font-semibold mb-4 text-green-800">Verify Collection</h3>
        ...
        <div className="mb-4">
          ...
          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-green-300 rounded-md">
        ...
        <Button
          ...
          variant="outline"
          className="w-full mt-2 border-green-300 text-green-600 hover:bg-green-100"
        >
          Close
        </Button>
      </div>
